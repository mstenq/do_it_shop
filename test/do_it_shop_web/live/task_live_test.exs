defmodule DoItShopWeb.TaskLiveTest do
  use DoItShopWeb.ConnCase

  import Phoenix.LiveViewTest
  import DoItShop.TasksFixtures

  @create_attrs %{due_date: "2023-11-27", notes: "some notes", priority: :high, qty: 42, status: "some status", title: "some title"}
  @update_attrs %{due_date: "2023-11-28", notes: "some updated notes", priority: :medium, qty: 43, status: "some updated status", title: "some updated title"}
