defmodule DoItShop.UsersTest do
  ...
  describe "register_user/1" do
    ...
    test "creates the personal account" do
      ...
      assert %DoItShop.Accounts.Account{personal: true} = user.personal_account
      assert [%DoItShop.Accounts.Membership{role: :owner}] = user.memberships
    end
  end
